...
const TermsOfService = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mt-4">
        We are GeeksforGeeks.Dev("Company," "we," "us," "our"). We operate , as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </p>
      <p className="mt-4">
        You can contact us by email at GeeksforGeeks.Dev.
      </p>
      <p className="mt-4">
      ...
      <ol className="list-decimal ml-8 mt-4 space-y-2">
        <li><a href="#section-1" className="text-blue-600">OUR SERVICES</a></li>
        <li><a href="#section-2" className="text-blue-600">INTELLECTUAL PROPERTY RIGHTS</a></li>
        <li><a href="#section-3" className="text-blue-600">USER REPRESENTATIONS</a></li>
        <li><a href="#section-4" className="text-blue-600">PROHIBITED ACTIVITIES</a></li>
        <li><a href="#section-5" className="text-blue-600">USER GENERATED CONTRIBUTIONS</a></li>
        <li><a href="#section-6" className="text-blue-600">CONTRIBUTION LICENSE</a></li>
        <li><a href="#section-7" className="text-blue-600">SERVICES MANAGEMENT</a></li>
        <li><a href="#section-8" className="text-blue-600">TERM AND TERMINATION</a></li>
        <li><a href="#section-9" className="text-blue-600">MODIFICATIONS AND INTERRUPTIONS</a></li>
        <li><a href="#section-10" className="text-blue-600">GOVERNING LAW</a></li>
        <li><a href="#section-11" className="text-blue-600">DISPUTE RESOLUTION</a></li>
        <li><a href="#section-12" className="text-blue-600">CORRECTIONS</a></li>
        <li><a href="#section-13" className="text-blue-600">DISCLAIMER</a></li>
        <li><a href="#section-14" className="text-blue-600">LIMITATIONS OF LIABILITY</a></li>
        <li><a href="#section-15" className="text-blue-600">INDEMNIFICATION</a></li>
        <li><a href="#section-16" className="text-blue-600">USER DATA</a></li>
        <li><a href="#section-17" className="text-blue-600">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
        <li><a href="#section-18" className="text-blue-600">MISCELLANEOUS</a></li>
        <li><a href="#section-19" className="text-blue-600">CONTACT US</a></li>
      </ol>

      <h2 id="section-1" className="text-2xl font-semibold mt-8">1. OUR SERVICES</h2>
      <p className="mt-4">
        The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.
      </p>

      <h2 id="section-2" className="text-2xl font-semibold mt-8">2. INTELLECTUAL PROPERTY RIGHTS</h2>
      ...
      <h3 className="text-xl font-semibold mt-6">Your use of our Services</h3>
      <p className="mt-4">
      ...
      <h3 className="text-xl font-semibold mt-6">Your submissions</h3>
      <p className="mt-4">
        Please review this section and the "PROHIBITED ACTIVITIES" section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.
      </p>
      <h4 className="text-lg font-semibold mt-4">Submissions:</h4>
      <p className="mt-4">
        By directly sending us any question, comment, suggestion, idea, feedback, or other information about the Services ("Submissions"), you agree to assign to us all intellectual property rights in such Submission. You agree that we shall own this Submission and be entitled to its unrestricted use and dissemination for any lawful purpose, commercial or otherwise, without acknowledgment or compensation to you.
      </p>
      <h4 className="text-lg font-semibold mt-4">You are responsible for what you post or upload:</h4>
      <p className="mt-4">
      ...
      <h2 id="section-3" className="text-2xl font-semibold mt-8">3. USER REPRESENTATIONS</h2>
      <p className="mt-4">
      ...
      <h2 id="section-4" className="text-2xl font-semibold mt-8">4. PROHIBITED ACTIVITIES</h2>
      <p className="mt-4">
      ...
      <h2 id="section-5" className="text-2xl font-semibold mt-8">5. USER GENERATED CONTRIBUTIONS</h2>
      <p className="mt-4">
      ...
      <h2 id="section-6" className="text-2xl font-semibold mt-8">6. CONTRIBUTION LICENSE</h2>
      <p className="mt-4">
      ...
      <h2 id="section-7" className="text-2xl font-semibold mt-8">7. SERVICES MANAGEMENT</h2>
      <p className="mt-4">
      ...
      <h2 id="section-8" className="text-2xl font-semibold mt-8">8. TERM AND TERMINATION</h2>
      <p className="mt-4">
      ...
      <h2 id="section-9" className="text-2xl font-semibold mt-8">9. MODIFICATIONS AND INTERRUPTIONS</h2>
      <p className="mt-4">
      ...
      <h2 id="section-10" className="text-2xl font-semibold mt-8">10. GOVERNING LAW</h2>
      <p className="mt-4">
      ...
      <h2 id="section-11" className="text-2xl font-semibold mt-8">11. DISPUTE RESOLUTION</h2>
      <h3 className="text-xl font-semibold mt-6">Informal Negotiations</h3>
      <p className="mt-4">
      ...
      <h3 className="text-xl font-semibold mt-6">Binding Arbitration</h3>
      <p className="mt-4">
      ...
      <h3 className="text-xl font-semibold mt-6">Exceptions to Informal Negotiations and Arbitration</h3>
      <p className="mt-4">
      ...
      <h2 id="section-12" className="text-2xl font-semibold mt-8">12. CORRECTIONS</h2>
      <p className="mt-4">
        There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.
      </p>

      <h2 id="section-13" className="text-2xl font-semibold mt-8">13. DISCLAIMER</h2>
      <p className="mt-4">
      ...
      <h2 id="section-14" className="text-2xl font-semibold mt-8">14. LIMITATIONS OF LIABILITY</h2>
      <p className="mt-4">
      ...
      <h2 id="section-15" className="text-2xl font-semibold mt-8">15. INDEMNIFICATION</h2>
      <p className="mt-4">
      ...
      <h2 id="section-16" className="text-2xl font-semibold mt-8">16. USER DATA</h2>
      <p className="mt-4">
        We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.
      </p>

      <h2 id="section-17" className="text-2xl font-semibold mt-8">17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
      <p className="mt-4">
      ...
      <h2 id="section-18" className="text-2xl font-semibold mt-8">18. MISCELLANEOUS</h2>
      <p className="mt-4">
      ...
      <h2 id="section-19" className="text-2xl font-semibold mt-8">19. CONTACT US</h2>
      <p className="mt-4">
        In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:
      </p>
      <p className="mt-4">contact@geeksforgeeks.dev</p>
    </div>
  );
};
